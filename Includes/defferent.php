<section class="text-gray-600 body-font" id="deff">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 class="sm:text-3xl text-2xl font-semibold title-font mb-2 text-gray-900">What makes us different</h1>
    </div>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Here's why we are the favourite choice of our students.</p>
    </div>
    <div class="flex flex-wrap -m-4">
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <div class="bg-white h-40 rounded w-full object-cover object-center mb-2" alt="content"><center><img src="/Images/activities.png" width="150"/></center></div>
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">Classes</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Smart Classes</h2>
          <p class="leading-relaxed text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
      </div>

      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <div class="bg-white h-40 rounded w-full object-cover object-center mb-2" alt="content"><center><img src="/Images/smart.png" width="150"/></center></div>
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">Classes</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Smart Classes</h2>
          <p class="leading-relaxed text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <div class="bg-white h-40 rounded w-full object-cover object-center mb-2" alt="content"><center><img src="/Images/quiz.png" width="150"/></center></div>
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">Classes</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Smart Classes</h2>
          <p class="leading-relaxed text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <div class="bg-gray-100 p-6 rounded-lg">
          <div class="bg-white h-40 rounded w-full object-cover object-center mb-2" alt="content"><center><img src="/Images/notes.png" width="150"/></center></div>
          <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">Classes</h3>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Smart Classes</h2>
          <p class="leading-relaxed text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
